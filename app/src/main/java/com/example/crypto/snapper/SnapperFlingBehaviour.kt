...
package com.example.crypto.snapper
...
class SnapperFlingBehavior(
    ...
    override suspend fun ScrollScope.performFling(
        ...
        Log.d("SnapperFlingBehaviour", "initialVelocity: $initialVelocity")
    ...
    private suspend fun ScrollScope.flingToIndex(
        ...
        if (initialItem.index == index && layoutInfo.distanceToIndexSnap(initialItem.index) == 0) {
            ...
            Log.d(
                "SnapperFlingBehaviour", "Skipping fling: already at target. " +
                        "vel:$initialVelocity, " +
    ...
    private suspend fun ScrollScope.performDecayFling(
        ...
        if (initialItem.index == targetIndex && layoutInfo.distanceToIndexSnap(initialItem.index) == 0) {
            Log.d(
                "SnapperFlingBehaviour", "Skipping decay: already at target. " +
                        "vel:$initialVelocity, " +
        ...
        Log.d(
            "SnapperFlingBehaviour", "Performing decay fling. " +
                    "vel:$initialVelocity, " +
                    "current item: $initialItem, " +
                    "target: $targetIndex"
        )
    ...
    private suspend fun ScrollScope.performSpringFling(
        ...
        Log.d(
            "SnapperFlingBehaviour", "Performing spring. " +
                    "vel:$initialVelocity, " +
                    "initial item: $initialItem, " +
                    "target: $targetIndex"
        )
    ...
    private fun AnimationScope<Float, AnimationVector1D>.performSnapBackIfNeeded(
        ...
        Log.d(
            "SnapperFlingBehaviour", "scroll tick. " +
                    "vel:$velocity, " +
        ...
        if (snapBackAmount != 0) {
            ...
            Log.d(
                "SnapperFlingBehaviour", "Scrolled past item. " +
                        "vel:$velocity, " +
                        "current item: $currentItem} " +
                        "target:$targetIndex"
            )
    ...
    private fun DecayAnimationSpec<Float>.canDecayBeyondCurrentItem(
        ...
        Log.d(
            "SnapperFlingBehaviour", "canDecayBeyondCurrentItem. " +
